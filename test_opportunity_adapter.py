...
def test_adapter_integrity():
    ...
    liushishishan_matches = [s for s in tw if s["name_i18n"]["zh-TW"] == "六十石山"]
    assert len(liushishishan_matches) == 1
    liushishishan = liushishishan_matches[0]
    assert liushishishan["spot_id"] == "tw-035"
