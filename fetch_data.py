...
def _build_open_meteo_url(spot):
    ...
    params = [
        f"latitude={lat}",
        f"longitude={lon}",
        "hourly=temperature_2m,dew_point_2m,relative_humidity_2m,cloud_cover_low,cloud_cover_mid,cloud_cover_high,wind_speed_10m,visibility,precipitation,precipitation_probability,snowfall,snow_depth,is_day",
