...
SPOT_OVERRIDES = {
 ...
 '摩周湖': {'lat': 43.555872,
         'lon': 144.507252,
         'scenes': ['lake', 'mountain', 'starlight'],
         'themes': ['mountain_view', 'milky_way'],
         'map_query': '摩周湖第一展望台 Kamuy Terrace',
         'coordinate_source': 'B32 Hokkaido official First Observatory page + official linked Google Maps coordinate',
         'coordinate_confidence': 'high'},
 '十和田湖': {'lat': 40.42646,
          'lon': 140.89324,
          'scenes': ['lake', 'forest', 'mountain'],
          'themes': ['mountain_view', 'reflection'],
          'map_query': '十和田湖 桟橋前広場 休屋',
          'coordinate_source': 'B32 Towadako official pier-front lake viewpoint + Aomori open data + OSM cross-check',
          'coordinate_confidence': 'high'},
 '松島': {'lat': 38.3525784,
        'lon': 141.0623503,
