...
REGIONS = {
    ...
    "jp": {
        ...
        "spots": [
            ...
            (43.7700, 142.3600, "旭岳 (北海道)", "Mt. Asahi (Hokkaido)", "旭岳 (北海道)", "旭岳", "北海道/東北", ["mountain", "starlight"]),
            ...
            (38.2600, 140.8800, "日本松島", "Matsushima", "松島", "松島", "北海道/東北", ["coast"]),
            ...
            (35.6250, 139.6140, "等等力溪谷 (東京)", "Todoroki Valley", "等々力渓谷", "等々力渓谷", "關東/中部", ["forest", "waterfall"]),
            (35.6700, 139.7500, "皇居 (東京)", "Imperial Palace Tokyo", "皇居", "皇居", "關東/中部", ["city"]),
    ...
    "us": {
        ...
        "spots": [
            ...
            (37.7310, -119.5230, "優勝美地 Half Dome", "Yosemite Half Dome", "ヨセミテ ハーフドーム", "Yosemite Half Dome", "美西", ["mountain", "starlight"]),
            (37.7160, -119.6770, "優勝美地 Tunnel View", "Yosemite Tunnel View", "ヨセミテ トンネルビュー", "Yosemite Tunnel View", "美西", ["mountain", "forest"]),
            ...
            (63.0690, -151.0080, "迪納利國家公園 (阿拉斯加)", "Denali National Park (AK)", "デナリ国立公園", "Denali NP", "阿拉斯加", ["mountain", "aurora", "starlight"]),
            (64.8410, -147.7180, "費爾班克斯極光 (阿拉斯加)", "Fairbanks Aurora (AK)", "フェアバンクス オーロラ", "Fairbanks", "阿拉斯加", ["aurora", "starlight"]),
            (65.0520, -146.0570, "珍娜溫泉 (阿拉斯加)", "Chena Hot Springs (AK)", "チェナ温泉", "Chena Hot Springs", "阿拉斯加", ["aurora", "starlight"]),
            (61.2180, -149.9000, "安克拉治 (阿拉斯加)", "Anchorage (AK)", "アンカレジ", "Anchorage", "阿拉斯加", ["city", "aurora"]),
            (60.1040, -149.4430, "蘇華德 (阿拉斯加)", "Seward (AK)", "スワード", "Seward", "阿拉斯加", ["coast", "aurora"]),
            (61.6400, -149.2870, "哈徹山口 (阿拉斯加)", "Hatcher Pass (AK)", "ハッチャーパス", "Hatcher Pass", "阿拉斯加", ["mountain", "aurora"]),
            (61.6530, -148.5970, "馬塔努斯卡冰河 (阿拉斯加)", "Matanuska Glacier (AK)", "マタヌスカ氷河", "Matanuska Glacier", "阿拉斯加", ["mountain", "aurora"]),
            (60.7830, -148.9070, "波蒂奇冰河 (阿拉斯加)", "Portage Glacier (AK)", "ポーテージ氷河", "Portage Glacier", "阿拉斯加", ["lake", "mountain"]),
            (61.1310, -146.3480, "瓦爾迪茲 (阿拉斯加)", "Valdez (AK)", "バルディーズ", "Valdez", "阿拉斯加", ["coast", "mountain"]),
            (58.3020, -134.4200, "朱諾 (阿拉斯加)", "Juneau (AK)", "ジュノー", "Juneau", "阿拉斯加", ["city", "coast"]),
            (58.4960, -134.5780, "門登霍爾冰河 (阿拉斯加)", "Mendenhall Glacier (AK)", "メンデンホール氷河", "Mendenhall Glacier", "阿拉斯加", ["lake", "mountain"]),
            (59.6430, -151.5380, "荷馬沙嘴 (阿拉斯加)", "Homer Spit (AK)", "ホーマー・スピット", "Homer Spit", "阿拉斯加", ["coast"]),
            (55.3430, -131.6470, "凱奇侃 (阿拉斯加)", "Ketchikan (AK)", "ケチカン", "Ketchikan", "阿拉斯加", ["coast"]),
            (59.4580, -135.3140, "史卡威 (阿拉斯加)", "Skagway (AK)", "スキャグウェイ", "Skagway", "阿拉斯加", ["coast", "mountain"]),
            (61.4520, -142.9690, "威朗格利-聖埃利亞斯 (阿拉斯加)", "Wrangell-St. Elias NP (AK)", "ランゲル・セントエライアス", "Wrangell-St. Elias", "阿拉斯加", ["mountain", "starlight"]),
            (68.1330, -149.4800, "布魯克斯山脈 (阿拉斯加)", "Brooks Range (AK)", "ブルックス山脈", "Brooks Range", "阿拉斯加", ["mountain", "aurora"]),
            (66.5620, -150.8130, "北極圈地標 (阿拉斯加)", "Arctic Circle Monument (AK)", "北極線標識", "Arctic Circle", "阿拉斯加", ["aurora", "starlight"]),
            (64.5010, -165.4060, "諾姆 (阿拉斯加)", "Nome (AK)", "ノーム", "Nome", "阿拉斯加", ["coast", "aurora"]),
            (58.5600, -155.1010, "卡特邁國家公園 (阿拉斯加)", "Katmai National Park (AK)", "カトマイ国立公園", "Katmai NP", "阿拉斯加", ["mountain", "forest"]),
            (58.4150, -135.7360, "冰河灣國家公園 (阿拉斯加)", "Glacier Bay National Park (AK)", "グレイシャーベイ国立公園", "Glacier Bay", "阿拉斯加", ["coast", "mountain"]),
            (57.7900, -152.4060, "柯迪亞克島 (阿拉斯加)", "Kodiak Island (AK)", "コディアック島", "Kodiak Island", "阿拉斯加", ["coast"]),
            (61.4070, -149.1220, "埃克盧特納湖 (阿拉斯加)", "Eklutna Lake (AK)", "エクルートナ湖", "Eklutna Lake", "阿拉斯加", ["lake", "aurora"]),
            (62.3230, -150.1070, "塔爾基特納 (阿拉斯加)", "Talkeetna (AK)", "タルキートナ", "Talkeetna", "阿拉斯加", ["mountain", "aurora"]),
            (60.9450, -149.1630, "艾利耶斯卡 (阿拉斯加)", "Alyeska Resort Girdwood (AK)", "アリエスカ リゾート", "Alyeska Girdwood", "阿拉斯加", ["mountain"]),
            (61.0660, -149.6500, "楚加奇州立公園 (阿拉斯加)", "Chugach State Park (AK)", "チュガッチ州立公園", "Chugach State Park", "阿拉斯加", ["mountain", "starlight"]),
            (66.0010, -166.6150, "白令陸橋 (阿拉斯加)", "Bering Land Bridge (AK)", "ベーリング陸橋", "Bering Land Bridge", "阿拉斯加", ["aurora"]),
            (64.7390, -156.8990, "育空河 (阿拉斯加)", "Yukon River (AK)", "ユーコン川", "Yukon River", "阿拉斯加", ["lake", "aurora"]),
            (68.5090, -161.0180, "諾阿塔克河 (阿拉斯加)", "Noatak River (AK)", "ノアタック川", "Noatak River", "阿拉斯加", ["lake", "aurora"]),
            (59.1050, -157.5500, "克拉克湖國家公園 (阿拉斯加)", "Lake Clark National Park (AK)", "レイククラーク国立公園", "Lake Clark", "阿拉斯加", ["lake", "aurora"]),
            (61.7890, -149.2730, "獨立礦山 (阿拉斯加)", "Independence Mine (AK)", "インデペンデンス鉱山", "Independence Mine", "阿拉斯加", ["mountain", "aurora"]),
        ],
    },
}
